...
for t in load_disaster_tweets(params.DATA_PATH, 123):
    print(t)

# for t in load_disaster_tweets(params.DATA_PATH, 123):
# print(t for t in load_disaster_tweets(params.DATA_PATH, 123))
exit()
(X, Y) = load_disaster_tweets(params.DATA_PATH, 123)
X_TRAIN, X_TEST, Y_TRAIN, Y_TEST = train_test_split(X, Y)

# nup array ffor item in Generator
...
model = m.mlp_model(
    params.NUM_LAYERS, units, params.DROPOUT, X_vect.shape, params.NUM_CLASSES
)
loss = m._get_loss()
